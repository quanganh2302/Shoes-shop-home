...
const Hero: React.FC<HeroProps> = ({ className }) => {
  return (
    <div
      ...
      className={cn(
        "w-full md:h-screen h-[50vh] bg-top bg-cover bg-no-repeat",
        className
      )}
    >
      <div className="lg:w-[400px] w-[300px] xl:block hidden absolute left-[50px] top-[480px]">
        <p className={cn("", textStyle.h1)}>Nike Air Max 90 lv8</p>
        <p className={cn("", textStyle.subTitle)}>Styles made for your game.</p>
        <Button
          className={cn(
